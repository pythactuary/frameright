"""
FrameRight Narwhals Backend Demo

Demonstrates FrameRight's backend support for Narwhals (backend-agnostic DataFrames):
- Uses StructFrameNarwhals for explicit narwhals backend
...
from frameright.typing.narwhals import Col as Col  # For narwhals autocomplete
